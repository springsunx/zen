...
async function processWithAI(configId, instruction, content, messages) {
  return await request('POST', '/api/ai/process/', { configId, instruction, content, messages: messages || [] });
}
