...
const COMMANDS = [
  ...
  { id: 'l1', icon: ListIcon, format: 'ul', label: () => t('slash.bullet'), desc: () => t('slash.bullet.desc') },
  { id: 'l2', icon: ListOrderedIcon, format: 'ol', label: () => t('slash.numbered'), desc: () => t('slash.numbered.desc') },
  { id: 'l3', icon: ListTodoIcon, format: 'todo', label: () => t('slash.task'), desc: () => t('slash.task.desc') },
